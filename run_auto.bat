...
echo [%date% %time%] Launching Collector... > "C:\Users\gary1\collector_output.log"
"%PYTHON_EXE%" run_collector.py --mode auto --query "墜飾幸運卷軸30%" --pages 2 >> "C:\Users\gary1\collector_output.log" 2>&1
