...
$logFile = "C:\Users\gary1\sort_test_run.log"

"$(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') Running test_sort..." | Out-File $logFile -Encoding utf8
& $python test_sort.py *>> $logFile
